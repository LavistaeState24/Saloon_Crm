export const leadImportFields = [
  ...
  { key: "propertyType", label: "Service Category", required: false, aliases: ["propertytype", "type", "bhk", "configuration"] },
  { key: "requirementType", label: "Service Preference", required: false, aliases: ["requirementtype", "requirement", "lookingfor", "propertyrequirement"] },
  ...
  { key: "leadStatus", label: "Customer Status", required: false, aliases: ["leadstatus", "status"] },
