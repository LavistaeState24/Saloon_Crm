...
import { createUserHandler, listAssignableUsersHandler, listUsersHandler } from "../controllers/userController.js";
...
router.get("/assignable", protect, authorize("clients", "view"), listAssignableUsersHandler);
